...
{ //extend the parent class here 
	public String displayCourseDetails(String dept) {
		...
		String commonSubjects = course.displayCourseDetails("ECE");//call the parent function after using inheritence
...
{ //extend the parent class here 
	public String displayCourseDetails(String dept) {
		Courses course = new Courses();
		// write or edit your code here 
		String commonSubjects = course.displayCourseDetails("Mechanical");;//call the parent function after using inheritence
...
{ //extend the parent class here 
	public String displayCourseDetails(String dept) {
		...
		Courses course = new Courses();
		// write or edit your code here 
		String commonSubjects = course .displayCourseDetails("CSE");;//call the parent function after using inheritence
...
public class Question1 {
	...
	public static void main(String[] args){
		...
		case 2:
		{
			...
			System.out.print(mech.displayCourseDetails("Mechanical"));
			break;
		}
		case 3:
		{
			...
			//call the function of the class that you initialized
			CSE cs = new CSE();
			System.out.print(cs.displayCourseDetails("CSE"));
			break;
		}
		default:
